...
class LetHimCookTheme {
  ...
  static const Color darkSecondaryColor = Color(0xFF383838);  // #383838 Secondary
  ...
  static const Color darkBackgroundColor = Color(0xFF000000); // #000000 Background
  ...
  static const Color lightSecondaryColor = Color(0xFF1B1D21);  // #1B1D21 Secondary
  ...
  static const Color lightBackgroundColor = Color(0xFFF6F6F8); // #F6F6F8 Background
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      displayLarge: TextStyle(color: darkTitleColor, fontWeight: FontWeight.bold),
      displayMedium: TextStyle(color: darkTitleColor, fontWeight: FontWeight.bold),
      displaySmall: TextStyle(color: darkTitleColor, fontWeight: FontWeight.bold),
      headlineMedium: TextStyle(color: darkTitleColor, fontWeight: FontWeight.bold),
      headlineSmall: TextStyle(color: darkTitleColor, fontWeight: FontWeight.bold),
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: const TextTheme(
      displayLarge: TextStyle(color: lightTitleColor, fontWeight: FontWeight.bold),
      displayMedium: TextStyle(color: lightTitleColor, fontWeight: FontWeight.bold),
      displaySmall: TextStyle(color: lightTitleColor, fontWeight: FontWeight.bold),
      headlineMedium: TextStyle(color: lightTitleColor, fontWeight: FontWeight.bold),
      headlineSmall: TextStyle(color: lightTitleColor, fontWeight: FontWeight.bold),
      titleLarge: TextStyle(color: lightTitleColor, fontWeight: FontWeight.bold),
